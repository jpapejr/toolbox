...
alias runon='docker run -i ${TERMS} --rm -v $HOME:$HOME -v $HOME/.krew:/home/user/.krew  -v $HOME/.kube:/home/user/.kube -e "HOME=/Users/jtpape" -e "LOCAL_USER_ID=`id -u $USER`" jpapejr/runon:1.14.0 runon'
